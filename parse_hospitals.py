...
def read_parse_hospital():
    ...
    with open('dataset/hospital/hospitals.csv', 'r') as data:
        data.readline().split(',')
    ...
    with open('dataset/hospital/hospital_latitude.txt', 'w') as f:
        simplejson.dump(lat, f)
        f.close()
    with open('dataset/hospital/hospital_longitude.txt', 'w') as f:
